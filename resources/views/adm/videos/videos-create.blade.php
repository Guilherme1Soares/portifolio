...
@section('content')
    ...
    <div class="container">
        ...
        <div class="form-area">
            ...
            <div class="form-box">
                ...
                <form action="{{ url('/adm/videos/create') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nomeDoVideo') is-invalid @enderror" id="nomeDoVideo" name="nomeDoVideo" maxlength="100" onkeyup="CountCaracters($(this).val().length,'title')" placeholder="Nome do vídeo" value="{{old('nomeDoVideo')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('autor') is-invalid @enderror" id="author" name="autor" maxlength="100" onkeyup="CountCaracters($(this).val().length,'author')" placeholder="Autor do vídeo" value="{{old('autor')}}">
                    ...
                    <div class="form-group" id="area-video">
                        ...
                        <input type="text" class="form-control @error('idDoVideo') is-invalid @enderror" id="idDoVideo" name="idDoVideo" maxlength="255" placeholder="ID do vídeo" value="{{old('idDoVideo')}}">
                    ...
                    <div class="form-group" id="videoFrame">
                        ...
                        <iframe id="ytVideo" src="https://www.youtube.com/embed/6NKhcV3v2nw" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    ...
    <script type="text/javascript">
        ...
        $("#idDoVideo").keyup(function(){

            var buscar  = $(this).val();

            $("#ytVideo").attr('src','https://www.youtube.com/embed/'+buscar);
